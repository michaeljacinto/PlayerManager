...
class CoachPopupView(tk.Frame):
    ...
    def _send_json(self):
        ...
        if flag:
            ...
            response = requests.post('http://127.0.0.1:5000/roster_manager/team_members', json=coach_json)
            # json_response = response.json()
            print(response.content)
            tkMessageBox.askokcancel("Coach Add", "Add coach?")
            ...
            if response.status_code != 200:
                ...
                tkMessageBox.showinfo("Success", "Coach has been successfully added.")
